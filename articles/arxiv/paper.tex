...
\begin{document}
  ...
  \label{sec:introduction}
    ...
    \todo[inline]{Justify expected runs as the reward rather than win probability.}
  ...
  \todo[inline]{Justify in simple terms that inning in a baseball eventually halts.}
