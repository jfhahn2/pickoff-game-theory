...
\EMAIL{andrew.schaefer@rice.edu}}
 ...
 \section{Introduction}
  \label{sec:introduction}
    ...
    \begin{align*}
      b &\in \{0, 1\}^3 \text{ are the bases occupied by runners};\\
      c &\in \{0, 1, 2, 3\} \times \{0, 1, 2\} \text{ is the ball-strike count};\\
      d &\in \{0, 1, 2\} \text{ denotes the number of disengagements already used; and}\\
      o &\in \{0, 1, 2\} \text{ denotes the number of outs}.
    \end{align*}
...
where ${\cal L} \defeq [0,20]$ is the set of allowable lead distances for the first-base runner, and
    ...
    \label{eqn:pitcher_action_sapce}
        A_{\text{P}}(s,a_\text{R}) \defeq \begin{cases}
            ...
            \{\delta\} \text{ if } s = (b,c,d,o)\\
            \quad \text{ with } b \neq (1,0,0),
            \\ \quad \text{ or } s \in {\cal P} {\cup} \{\Delta\},         \end{cases} \forall s \in {\cal S}, 
            a_\text{R} \in A_\text{R}(s),
            \end{align}            
