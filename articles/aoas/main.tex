...
%%%% Main text entry area:
 ...
 \section{Introduction}
  \label{sec:introduction}
    ...
    \begin{figure}
      \centering
      \includegraphics[width = 10cm]{leads_overall_light.pdf}
      \caption{
  ...
  \label{sec:results}
    ...
    \label{sec:results-multilevel-model}
      ...
      \begin{figure}
        \centering
        \includegraphics[width = 6cm]{prob_po_attempt_light.pdf}
        \includegraphics[width = 6cm]{prob_po_success_light.pdf}
        \caption{
      ...
      \begin{figure}
        \centering
        \includegraphics[width = 10cm]{prob_sb_success_light.pdf}
        \caption{
      ...
      \begin{figure}
        \centering
        \includegraphics[width = 6cm]{effect_catcher_light.pdf}
        \includegraphics[width = 6cm]{effect_runner_light.pdf}
        \caption{
          \it
