...
%%%% Main text entry area:
 ...
 \section{Introduction}
  ...
  \label{sec:sg-model}
    ...
    \noindent {\color{blue}{We establish in the Supplementary Material that the iterates $V^k$ generated in \eqref{eqn:vi_algorithm} converge to the optimal value function $V^*$ at a linear rate.}}  
