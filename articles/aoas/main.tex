...
%%                                          %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Lead distance under a pickoff limit in Major League Baseball: A sequential game model}
  ...
  \label{sec:transition-probability-model}
    ...
    \label{sec:prob-state-transition}
      ...
      \begin{align}
        ...
        \end{split}
      \end{align}
      where $ = \mathbb{I}\left\{\tilde s_i = \tilde s,\, r_i = r\right\}$ and $1_i^{\tilde s', e}= \mathbb{I}\left\{\tilde s_{i+1} = \tilde s',\, d_{i+1} - d_i = e\right\}$. Finally, we estimate the full-state transition probabilities as
      \begin{align*}
